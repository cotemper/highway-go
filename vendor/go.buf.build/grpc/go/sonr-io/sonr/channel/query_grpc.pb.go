...
func (UnimplementedQueryServer) HowIs(context.Context, *QueryGetHowIsRequest) (*QueryGetHowIsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HowIs not implemented")
}
func (UnimplementedQueryServer) HowIsAll(context.Context, *QueryAllHowIsRequest) (*QueryAllHowIsResponse, error) {
